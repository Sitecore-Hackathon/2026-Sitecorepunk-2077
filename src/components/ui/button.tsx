  ...
  ].join(" "),
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        colorScheme: "danger",
        class:
          "bg-destructive text-inverse-text hover:bg-destructive-hover active:bg-destructive-active",
      },
      {
        variant: "default",
        colorScheme: "neutral",
      ...
      },
      {
        ...
        colorScheme: "danger",
        class:
          "border text-destructive-foreground hover:bg-destructive-bg hover:text-destructive-foreground active:bg-destructive-bg-active",
      },
      {
        variant: "outline",
        colorScheme: "neutral",
      ...
      },
      {
        ...
        colorScheme: "danger",
        class:
          "text-destructive-foreground hover:bg-destructive-bg hover:text-destructive-foreground active:bg-destructive-bg-active",
      },
      {
        variant: "ghost",
        colorScheme: "neutral",
...
function Button({
  ...
  // Map variant="destructive" to default + danger (Blok uses colorScheme for semantics)
  const resolvedVariant = variant === "destructive" ? "default" : variant;
  let resolvedColorSchemeFinal = colorScheme;

  if (variant === "destructive" || !colorScheme) {
    if (variant === "destructive") {
      resolvedColorSchemeFinal = "danger";
    } else {
      switch (variant) {
        case "default":
        case "link":
